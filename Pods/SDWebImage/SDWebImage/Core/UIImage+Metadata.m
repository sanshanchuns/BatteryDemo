...
- (NSString *)sd_imageDecoder {
    return objc_getAssociatedObject(self, @selector(sd_imageDecoder));
}

- (void)setSd_imageDecoder:(NSString *)sd_imageDecoder {
    objc_setAssociatedObject(self, @selector(sd_imageDecoder), sd_imageDecoder, OBJC_ASSOCIATION_COPY_NONATOMIC);
}

- (NSTimeInterval)sd_imageDecodeCost {
    NSNumber *value = objc_getAssociatedObject(self, @selector(sd_imageDecodeCost));
    return value.doubleValue;
}

- (void)setSd_imageDecodeCost:(NSTimeInterval)sd_imageDecodeCost {
    objc_setAssociatedObject(self, @selector(sd_imageDecodeCost), @(sd_imageDecodeCost), OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
