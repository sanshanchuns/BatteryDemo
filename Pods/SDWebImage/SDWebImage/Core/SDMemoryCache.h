...
extern NSString *_Nonnull SDMemoryCacheInfoKindKey;
extern NSString *_Nonnull SDMemoryCacheInfoHitRatioKey;
extern NSString *_Nonnull SDMemoryCacheInfoAverageQueryTimeKey;
extern NSString *_Nonnull SDMemoryCacheInfoTotalQueryCountKey;
extern NSString *_Nonnull SDMemoryCacheInfoNotification;
