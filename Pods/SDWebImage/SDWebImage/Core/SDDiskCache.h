...
FOUNDATION_EXPORT NSString *_Nonnull const SDDiskCacheExtendedKeyDiskAge;
...
- (nullable id)extendedObjectForKey:(nonnull NSString *)key;
...
- (void)setExtendedObject:(nullable id)extendedObject forKey:(nonnull NSString *)key;
...
@interface SDDiskCacheConfigInfo : NSObject<NSSecureCoding>

@property (nonatomic, assign) NSTimeInterval maxDiskAge;
@property (nonatomic, copy, nonnull) NSString *diskCachePath;
@property (nonatomic, assign) SDImageCacheConfigExpireType diskCacheExpireType;

- (instancetype)initWithMaxDiskAge:(NSTimeInterval)maxDiskAge
                     diskCachePath:(nonnull NSString *)diskCachePath
...
- (nullable NSData *)extendedDataForPath:(nonnull NSString *)path;
- (void)setExtendedData:(nonnull NSData *)extendedData forPath:(nonnull NSString *)path;

- (nullable id)extendedObjectForPath:(nonnull NSString *)path;
- (void)setExtendedObject:(nullable id)extendedObject forPath:(nonnull NSString *)path;

- (void)removeDataForPath:(nonnull NSString *)path;

+ (uint64_t)removeExpiredDataWithCacheConfigs:(nonnull NSArray<SDDiskCacheConfigInfo *> *)cacheConfigs;
