...
@property (class, assign, nonatomic) BOOL shouldRemoveExpiredDataWhenEnterBackground;
...
@property (class, assign, nonatomic) NSUInteger maxTotalDiskSize;

@property (class, assign, nonatomic) NSInteger clearDiskTimeout;
