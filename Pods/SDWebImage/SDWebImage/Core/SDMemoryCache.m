...
NSString *SDMemoryCacheInfoKindKey = @"kind";
NSString *SDMemoryCacheInfoHitRatioKey = @"hit_ratio";
NSString *SDMemoryCacheInfoAverageQueryTimeKey = @"query_time";
NSString *SDMemoryCacheInfoTotalQueryCountKey = @"total_count";
NSString *SDMemoryCacheInfoNotification = @"SDMemoryCacheInfoNotification";
