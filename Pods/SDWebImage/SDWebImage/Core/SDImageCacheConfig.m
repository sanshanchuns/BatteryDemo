...
static NSUInteger s_maxTotalDiskSize = 0;
static NSInteger s_clearDiskTimeout = 0;
static BOOL s_shouldRemoveExpiredDataWhenEnterBackground = YES;
...
+ (NSUInteger)maxTotalDiskSize {
    return s_maxTotalDiskSize;
}

+ (void)setMaxTotalDiskSize:(NSUInteger)maxTotalDiskSize {
    s_maxTotalDiskSize = maxTotalDiskSize;
}

+ (NSInteger)clearDiskTimeout {
    return s_clearDiskTimeout;
}

+ (void)setClearDiskTimeout:(NSInteger)clearDiskTimeout {
    s_clearDiskTimeout = clearDiskTimeout;
}
    
+ (BOOL)shouldRemoveExpiredDataWhenEnterBackground {
    return s_shouldRemoveExpiredDataWhenEnterBackground;
}

+ (void)setShouldRemoveExpiredDataWhenEnterBackground:(BOOL)shouldRemoveExpiredDataWhenEnterBackground {
    s_shouldRemoveExpiredDataWhenEnterBackground = shouldRemoveExpiredDataWhenEnterBackground;
}
