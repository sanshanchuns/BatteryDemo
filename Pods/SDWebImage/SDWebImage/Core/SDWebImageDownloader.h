...
typedef NS_OPTIONS(NSUInteger, SDWebImageDownloaderOptions) {
    ...
    /**
     * Immediatly call completion block
     */
    SDWebImageDownloaderImmediateCallCompletionBlock = 1 << 29,
    
    /**
     * ImageDownloader not decode imageData, just return imageData
     */
    SDWebImageDownloaderReturnOnlyImageData = 1 << 30,
 ...
 */
__attribute__((annotate("oclint:ks[ks_deperacted]")))
