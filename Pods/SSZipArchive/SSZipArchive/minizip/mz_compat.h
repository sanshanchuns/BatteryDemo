...
ZEXPORT zipFile mz_zipOpen(const char *path, int append);
ZEXPORT zipFile mz_zipOpen64(const void *path, int append);
ZEXPORT zipFile mz_zipOpen2(const char *path, int append, const char **globalcomment,
    zlib_filefunc_def *pzlib_filefunc_def);
ZEXPORT zipFile mz_zipOpen2_64(const void *path, int append, const char **globalcomment,
    zlib_filefunc64_def *pzlib_filefunc_def);
        zipFile mz_zipOpen_MZ(void *stream, int append, const char **globalcomment);

ZEXPORT int     mz_zipOpenNewFileInZip5(zipFile file, const char *filename, const zip_fileinfo *zipfi,
...
ZEXPORT int     mz_zipWriteInFileInZip(zipFile file, const void *buf, uint32_t len);

ZEXPORT int     mz_zipCloseFileInZipRaw(zipFile file, uint32_t uncompressed_size, uint32_t crc32);
ZEXPORT int     mz_zipCloseFileInZipRaw64(zipFile file, int64_t uncompressed_size, uint32_t crc32);
ZEXPORT int     mz_zipCloseFileInZip(zipFile file);
ZEXPORT int     mz_zipCloseFileInZip64(zipFile file);

ZEXPORT int     mz_zipClose(zipFile file, const char *global_comment);
ZEXPORT int     mz_zipClose_64(zipFile file, const char *global_comment);
ZEXPORT int     mz_zipClose2_64(zipFile file, const char *global_comment, uint16_t version_madeby);
...
ZEXPORT void*   mz_zipGetStream(zipFile file);
